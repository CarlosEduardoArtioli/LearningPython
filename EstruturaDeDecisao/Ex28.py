...
print()
tipo = str(input('Informe o tipo de carne: ').upper())
quantidade = float(input('Informe a quantidade(em Kg): '))
cartao = str(input('Deseja utilizar o cartão Tabajara? ').upper())
...
print('Quantidade de carne:', quantidade)
print('Total da compra:', valor)

if cartao == 'S':
    valor -= valor * 0.05
    print('Utilizando cartão Tabajara: Sim')
    print('Desconto: 5%')
